...
`--no-deps` is required on the `qwen-tts` line. `qwen-tts` 0.1.1 pins Transformers
4.57.3, and letting it install that pin replaces the stack the rest of SGLang-Omni
is built against.
